...
void line_sensor_init(void) {
    ...
    gpio_pull_up(LINE_DIGITAL_PIN);
    printf("[LINE_SENSOR] Digital Input Initialized on GPIO %d\n", LINE_DIGITAL_PIN);
}
...
line_state_t line_sensor_read(void) {
    ...
    bool digital_value = gpio_get(LINE_DIGITAL_PIN);
    return digital_value ? LINE_BLACK : LINE_WHITE;
}
